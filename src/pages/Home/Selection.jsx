...
const ResultCard = ({ item, index }) => {
  ...
  return (
    <div
      ref={ref}
      className="rounded-2xl lg:rounded-3xl bg-white/70 backdrop-blur-md border border-white shadow-lg p-4 lg:p-5 transition-all duration-700 ease-out hover:-translate-y-2 hover:shadow-2xl"
      style={{
        opacity: inView ? 1 : 0,
